package com.tianshaokai.app.canvasdemo.myview;
...
public class MyView extends View {
    ...
    private void drawPath(Canvas canvas) {
        ...
        //向Path中添加Circle
        path.addCircle((float) (deltaX * 2.5), deltaY / 2f, deltaY / 2f, Path.Direction.CCW);
        //向Path中添加Rect
