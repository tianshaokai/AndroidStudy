...
import com.tianshaokai.camera.adapter.MyAdapter;
import com.tianshaokai.camera.entity.MyFunction;
import com.tianshaokai.camera.record.AudioRecordActivity;
import com.tianshaokai.camera.record.VideoRecordActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<MyFunction> list = Arrays.asList(
                ...
                new MyFunction("测试", TestActivity.class),
